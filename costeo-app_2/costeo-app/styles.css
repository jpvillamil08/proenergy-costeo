    ...
    if (estadoInicial === null) {
      try {
        ...
        if (estadoInicial === 'sin-configurar') {
          mensajesEl.innerHTML = '<div class="asis-vacio">El asistente todavía no está configurado. En Railway, pestaña <strong>Variables</strong> del servicio, agrega <code>ANTHROPIC_API_KEY</code> con una API key de Claude/Anthropic.</div>';
        }
